...
* 由此在这里就可以计算假设有1人选择了微信作为转发平台，其转发给好友(问卷5题得到84.38%概率转发给好友)所带来的扩散，还分为使用多选功能和不使用多选功能(问卷第10题)，分别计算使用多选功能带来的潜在转发用户数量=1✖️转发给好友的比例(84.38%)✖️使用多选功能的比例(82.22%)。Translate：Therefore, it can be calculated here that if one person chooses wechat as the forwarding platform, the diffusion caused by the person's forwarding to friends (the probability of forwarding 5 questions to friends is 84.38%) can be divided into using the multi-choice function and not using the multi-choice function (question 10 of the questionnaire). Calculate the potential number of retweets caused by using the multiple choice function =1✖️ proportion of retweets to friends (84.38%)✖️ proportion of using the multiple choice function (82.22%).
* 而多选功能带来的潜在用户数量还需要看他们有会转发给多少人来进行计算，由此我们在问题11中让用户填写他们使用多选功能会给多少好友转发，因此实际上“多选功能带来的潜在转发用户数量”==1✖️转发给好友的比例(84.38%)✖️使用多选功能的比例(82.22%)✖️(问题11中的不同比例下会转发给多少人)，就是说1✖️转发给好友的比例(84.38%)✖️使用多选功能的比例(82.22%)✖️(8.11%*2+35.14%*3+18.92%*4+8.11%*5+8.11%*6+5.41%*8)。Translate：The number of potential users brought by the multi-choice function also needs to be calculated by how many people they will forward to. Therefore, in question 11, we asked users to fill in how many friends they will forward to using the multi-choice function. Therefore, in fact, "potential number of forwarded users due to the multiple choice function" ==1✖️ proportion of forwarded users to friends (84.38%)✖️ proportion of using the multiple choice function (82.22%)✖️(how many people will be forwarded to under different proportions in question 11), Is 1 ✖ ️ forwarded to his best friend's proportion (84.38%) ✖ ️ use multiselect feature of proportion (82.22%) ✖ ️ (8.11% 35.14% * * 2 + 3 + 18.92% * 4 * 5 * 6 + 8.11% + 5.41% + 8.11% * 8)
* 但是这些人他们打开了这个内容链接吗？或者说他们有没有B站的APP？他们有APP但是他们会跳转到B站去看吗还是直接观看？因为只有选择跳转到B站的客户端观看才能够被记入到播放量中，不然就不算播放量。由此我们在问卷中的第12题问“您分享的qq或者微信好友，他们都是B站的用户群体吗？”来查看他们是否有APP，这道题目只有选择了在微信和QQ中转发给好友而非转发给群聊的用户才能够填写。而有B站属于B站用户群体的人不一定会跳转到B站客户端观看，所有我们在问卷第3题问了B站用户他们看到好友在微信或者QQ转发的B站内容链接是否会跳转到B站客户端播放内容。在第25题提问“您转发分享给好友后的内容，您的好友会查看吗”。所以说最终微信中使用多选功能能够带来的实际被动播放量为==1(假设有一个人使用微信进行转发)✖️选择转发给好友的比例(84.38%)✖️使用多选功能的比例(82.22%)✖️(8.11%*2+35.14%*3+18.92%*4+8.11%*5+8.11%*6+5.41%*8+5.41%*9)✖️(多少比例的人是B站用户群体86.67%)✖️(选择跳转至APP观看的比例30.93%)✖️(查看内容的比例92.31%)==1✖️84.38%✖️82.22%✖️(8.11%*2+35.14%*3+18.92%*4+8.11%*5+8.11%*6+5.41%*8+5.41%*9)✖️86.67%✖️30.93%✖️92.31%=0.6498009543667105。 Translate：But these people did they open this content link? Or do they have an APP for Station B? They have the APP but do they go to B or do they just watch it? Because only the client viewing that chooses to jump to station B can be recorded in the playback volume, otherwise it is not the playback volume. Therefore, in the 12th question of the questionnaire, we asked "Are the qq or wechat friends you share all the user groups of Station B?" To check whether they have an APP, this question can only be filled by users who have chosen to send it to friends in wechat and QQ instead of forwarding it to group chats. People who belong to the user group of Station B may not necessarily jump to the client of Station B to watch. Therefore, in question 3 of the questionnaire, we asked the users of Station B whether they would jump to the client of Station B to play the content if they saw the content link of Station B forwarded by their friends in wechat or QQ. Question 25 asks, "Will your friends view the content you share with them?" Therefore, in the end, the actual number of passive plays brought about by the use of multiple selection function on wechat is ==1(assuming a person uses wechat to forward)✖️ proportion of people who choose to forward to friends (84.38%)✖️ proportion of people who use the function of multiple selection (82.22%)✖️(8.11%*2+35.14%*3+18.92%*4+8.11%* 5 + 6 + 8.11% * 5.41% * 5.41% * 8 + 9) ✖ ️ (how many percentage of the user group B is 86.67%) ✖ ️ (choose to jump to the APP to watch the proportion of 30.93%) ✖ ️ (see content 92.31%) = = 1 ✖ ️ 84.38% ✖ ️ 82.22% ✖ ️ (8.11% * 2 + 3 * * 4 + 3 + 18.92% 5.14% 8.11% * 5 * 6 + 8.11% + 5.41% * 5.41% * 8 + 9) ✖ ️ 86.67% ✖ ️ 30.93% ✖ ️ = 0.6498009543667105 92.31%
